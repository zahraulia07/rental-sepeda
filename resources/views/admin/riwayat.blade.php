...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .container { max-width: 1200px; margin: auto; background: #fff; padding: 32px; border-radius: 24px; box-shadow: 0px 14px 40px rgba(15, 23, 42, 0.07); border: 1px solid #eef2f7; }
        ...
        .row-riwayat { cursor: pointer; }
        .row-riwayat:hover td { background-color: #fafbff; }
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr class="row-riwayat" onclick="openDetail(this)"
                    data-id="{{ $t->user_id }}"
